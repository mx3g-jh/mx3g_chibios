...
#define SHARED_DMA_MASK ((1U<<STM32_DMA_STREAM_ID(1,3))|(1U<<STM32_DMA_STREAM_ID(1,2))|(1U<<STM32_DMA_STREAM_ID(1,4))|(1U<<STM32_DMA_STREAM_ID(1,5))|(1U<<STM32_DMA_STREAM_ID(1,7)))
...
#define HAL_USART1_CONFIG { (BaseSequentialStream*) &SD1, 1, false, STM32_USART1_RX_DMA_CONFIG, STM32_USART1_TX_DMA_CONFIG, PAL_LINE(GPIOB,6U), PAL_LINE(GPIOB,7U), 0, 0, -1, 0, -1, 0}
...
#define HAL_UART4_CONFIG { (BaseSequentialStream*) &SD4, 4, false, STM32_UART4_RX_DMA_CONFIG, STM32_UART4_TX_DMA_CONFIG, PAL_LINE(GPIOD,1U), PAL_LINE(GPIOD,0U), 0, 0, -1, 0, -1, 0}
#define HAL_HAVE_RTSCTS_SERIAL5
#define HAL_USART6_CONFIG { (BaseSequentialStream*) &SD6, 6, false, STM32_USART6_RX_DMA_CONFIG, STM32_USART6_TX_DMA_CONFIG, 0, PAL_LINE(GPIOG,9U), PAL_LINE(GPIOG,8U), PAL_LINE(GPIOG,15U), -1, 0, -1, 0}
#define HAL_UART7_CONFIG { (BaseSequentialStream*) &SD7, 7, false, STM32_UART7_RX_DMA_CONFIG, STM32_UART7_TX_DMA_CONFIG, PAL_LINE(GPIOE,8U), PAL_LINE(GPIOF,6U), 0, 0, -1, 0, -1, 0}
